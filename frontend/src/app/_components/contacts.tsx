    ...
    <div className="bg-muted">
      <div className="container py-[32px] grid md:grid-cols-[1fr,2fr] gap-6">
        <div className="p-6 bg-white rounded-xl grid gap-4">
          ...
          <p>
            Екатеринбург, улица Мамина-Сибиряка, 52<br />
            Режим работы: Пн-Пт с 10:00 до 18:00<br />
            +7 (922) 207-50-50 - Виктория<br />
            <br />
            education@stom-coach.ru
          </p>
          <div className="flex gap-3 mt-6">
            <a href="https://vk.com/stomcoach" target="_blank" rel="noreferrer" className="bg-[#25D366] rounded-xl h-[48px] w-[48px] p-1.5">
        ...
        <div className="rounded-xl overflow-hidden">
          <MapComponent coordinates={[10, 10]} />
        </div>
      </div>
    </div>
  )
