      ...
      <div className="container py-[32px] grid md:grid-cols-[1fr,2fr] gap-6">
        <div className="p-6 bg-white rounded-xl grid gap-4">
          ...
          <div className="flex gap-3 mt-6">
            ...
            <a href={props.settings?.telegram_link} target="_blank" rel="noreferrer" className="bg-[#24A1DE] rounded-xl h-[48px] w-[48px] p-2">
              {/* Telegram icon */}
              {/* <img alt="svgIcon"  */}
              <img width="60" height="60" src="https://img.icons8.com/ios-glyphs/120/FFFFFF/telegram-app.png" alt="telegram-app" />
            </a>
