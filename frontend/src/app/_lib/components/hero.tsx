...
const Hero = (props: {
  data: APIResponse<"api::nastrojki.nastrojki">["data"]["attributes"];
  event: {
    event: Event;
    image: Image;
  };
        ...
        <div className="relative bg-neutral-800 rounded-xl overflow-hidden">
          ...
          <div className="relative text-white flex flex-col justify-between max-lg:rounded-xl gap-8 h-full p-8 bg-black/50">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="grid gap-3">
                <div className="flex gap-2  items-center content-center">
                  ...
                  <p>
                    {event.attributes.speakers?.data
                ...
                <div className="flex gap-2  items-center content-center">
                  ...
                  <p>
                    {DateTime.fromISO(event.attributes.date).toLocaleString(
                      DateTime.DATE_FULL
                    )}
                  </p>
                </div>
            ...
            <Link href={"/events/" + event.id}>
              <Button
                variant={"outline"}
                className="uppercase w-fit text-white border-white hover:text-black hover:bg-neutral-200"
              >
                Подробнее
              </Button>
            </Link>
